classdef	Grating < handle
    ...
    methods
        ...
        % Constructor method
        function[obj] = Grating( stimuli, exp_obj )
            
            % Contents of parsed_S for grating stim
            ...
            obj.grating_angle = direction;
            
            if stimuli.type == 'CG'
                obj.grating_angle = obj.grating_angle - 90;
            end
        ...
        end     % run single counterphase grating
